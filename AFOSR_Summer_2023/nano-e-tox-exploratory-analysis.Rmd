...
```{r}
material_test_org_toxicity_value_endpoint <- ggplot(nano_raw_toxicity_values_mg_l_noec, aes(y = name, x = value, color = type_of_test_organism_selection_bacteria_algae_crustacean_protozoa_fish_earthworm_other,
                                                    label = test_endpoint)) +
  geom_point() +
  theme_minimal() +
  theme(legend.position="none") +
...
```{r}
d <- ggplot(nano_raw_toxicity_values_mg_l_common_tox, aes(x = name,
                                               y = value,
                                               fill = name,
                                                label = test_endpoint)) +
  geom_boxplot() +
